...
#   - Python venv with faster-whisper + CUDA libs
#   - transcribe_server.py running as a systemd --user service
#   - voice-toggle.sh wrapper
...
install -m 0644 "$REPO_DIR/transcribe.py"        "$INSTALL_DIR/transcribe.py"
install -m 0644 "$REPO_DIR/transcribe_server.py" "$INSTALL_DIR/transcribe_server.py"
install -m 0644 "$REPO_DIR/transcribe_client.py" "$INSTALL_DIR/transcribe_client.py"
